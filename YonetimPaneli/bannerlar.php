                ...
                <table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
                    <tr height="40">
                        ...
                        <td width="175" align="left">
                            <img src="../Resimler/<?php echo DonusumleriGeriDondur($Bannerlar["BannerResmi"]) ?>" border="0" height="30">
                        </td>
                        ...
                        <td width="575" align="left">
                            <table width="575" align="right" border="0" cellpadding="0" cellspacing="0">
                                <tr height="20">
                                    ...
                                    <td width="175" align="left"><?php echo DonusumleriGeriDondur($Bannerlar["BannerAdi"]) ?></td>

                                    <td width="50" align="left"><b>Yeri</b></td>
                                    <td width="10" align="left"><b>:</b></td>
                                    <td width="170" align="left"><?php echo DonusumleriGeriDondur($Bannerlar["BannerAlani"]) ?></td>
                                ...
                                <tr height="20">
                                    <td colspan="9">
                                        <table width="575" align="right" border="0" cellpadding="0" cellspacing="0">
                                            <tr height="20">
                                                <td width="425">&nbsp;</td>
                                                <td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=38&ID=<?php echo DonusumleriGeriDondur($Bannerlar["id"]) ?>"><img src="../Resimler/" border="0" style="margin-top: 5px;"></a></td>
                                                ...
                                                <td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=42&ID=<?php echo DonusumleriGeriDondur($Bannerlar["id"]) ?>"><img src="../Resimler/carpi.jpg" border="0" style="margin-top: 5px;"></a></td>
