...
if(isset($_SESSION["Yonetici"])){
    ...
    if( ($GelenBankaLogosu["name"]!="") && ($GelenBankaLogosu["type"]!="") && ($GelenBankaLogosu["tmp_name"]!="") && ($GelenBankaLogosu["error"]==0) && ($GelenBankaLogosu["size"]>0) && ($GelenBankaAdi !="") && ($GelenKonumSehir !="") && 
        ($GelenKonumUlke !="") && ($GelenSubeAdi !="") && ($GelenSubeKodu !="") && ($GelenParaBirimi !="") && ($GelenHesapSahibi !="") && ($GelenHesapNumarasi !="") && ($GelenIbanNumarasi !="") ){
        ...
        $HesapEklemeSorgusu             =   $VeriTabaniBaglantisi->prepare("INSERT INTO bankahesaplari (BankaLogosu, BankaAdi, KonumSehir, KonumUlke, SubeAdi, SubeKodu, ParaBirimi, HesapSahibi, HesapNumarasi, IbanNumarasi) values(?,?,?,?,?,?,?,?,?,?) ");
