...
?>
    ...
    <table width="1065" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
        <tr height="100%">
            <td align="center" width="300" bgcolor="#001d26" valign="top">
                <table width="300" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr height="70">
                        <td align="center"><a href="index.php?SKD=0&SKI=0"><img src="../Resimler/" border="0"></a></td>
                    </tr>
            ...
            <td align="center" width="5" bgcolor="#FF0000" valign="top">&nbsp;</td>
            <td align="center" width="760" valign="top">

                <?php

                    if((!$IcSayfaKoduDegeri) || ($IcSayfaKoduDegeri=="") || ($IcSayfaKoduDegeri==0)) {
                        include($SayfaIc[0]);
                    }else {
