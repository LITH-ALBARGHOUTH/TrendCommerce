                    ...
                    <tr>
                        <td colspan="9" align="right">
                            <table width="95" align="right" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="20">&nbsp;</td>
                                    <td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=87&ID=<?php echo DonusumleriGeriDondur($Yonetici["id"]) ?>">
                                    <img src="../Resimler/carpi.jpg" border="0" style="margin-top: 5px;"></a></td>
                                    <td width="50"  align="left"><a href="index.php?SKD=0&SKI=87&ID=<?php echo DonusumleriGeriDondur($Yonetici["id"]) ?>" 
                                    style="color: green; text-decoration: none;">Geri Aç</a></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
            ...
            <td colspan="2" align="center">
                ...
                <div class="SayfalamaAlaniKapsayicisi">
                    ...
                    <div class="SayfalamaAlaniIciNumaraAlaniKapsayicisi">
                        <?php
                        if($Sayfalama>1){
                            echo "<span class='SayfalamaAktif'><a href='index.php?SKD=0&SKI=83" . $SayfalamaKosulu . "&SYF=1'><<</a></span>";
                            $SayfalamaIcinSayfaDegeriniBirGeriAl = $Sayfalama-1;
                            echo "<span class='SayfalamaAktif'><a href='index.php?SKD=0&SKI=83" . $SayfalamaKosulu . "&SYF=" . $SayfalamaIcinSayfaDegeriniBirGeriAl . "'><</a></span>";
                        }
                        ...
                        $Sayfalama+$SayfalamaIcınSolVeSagButonSayisi; $SayfalamaIcinSayfaIndexDegeri++) {
                            ...
                            if(($SayfalamaIcinSayfaIndexDegeri>0) && ($SayfalamaIcinSayfaIndexDegeri <= $BulunanSayfaSayisi)){
                                if($Sayfalama==$SayfalamaIcinSayfaIndexDegeri){
                                    ...
                                    echo "<span class='SayfalamaPasif'><a href='index.php?SKD=0&SKI=83" . $SayfalamaKosulu . "&SYF=" . $SayfalamaIcinSayfaIndexDegeri . "'>" . 
                        ...
                        if($Sayfalama != $BulunanSayfaSayisi){
                            ...
                            echo "<span class='SayfalamaAktif'><a href='index.php?SKD=0&SKI=83" . $SayfalamaKosulu . "&SYF=" . $SayfalamaIcinSayfaDegeriniBirIleriAl . "'>></a></span>";
                            echo "<span class='SayfalamaAktif'><a href='index.php?SKD=0&SKI=83" . $SayfalamaKosulu . "&SYF=" . $BulunanSayfaSayisi . "'>>></a></span>";
                        }
