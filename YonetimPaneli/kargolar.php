                ...
                <table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td width="200" align="left">
                            <img src="../Resimler/<?php echo DonusumleriGeriDondur($Kargolar["KargoFirmasiLogosu"]) ?>" border="0">
                        </td>
                        ...
                        <td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=26&ID=<?php echo DonusumleriGeriDondur($Kargolar["id"]) ?>"><img src="../Resimler/" border="0" style="margin-top: 15px;"></a></td>
                        ...
                        <td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=30&ID=<?php echo DonusumleriGeriDondur($Kargolar["id"]) ?>"><img src="../Resimler/carpi.jpg" border="0" style="margin-top: 15px;"></a></td>
