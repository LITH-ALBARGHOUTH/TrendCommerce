...
<form action="index.php?SKD=0&SKI=27&ID=<?php echo DonusumleriGeriDondur($GelenID); ?>" method="post" enctype="multipart/from-data">
    <table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
        <tr height="70">
            <td width="560" bgcolor="#FF9900" style="color: #FFFFFF" align="left"><h3>&nbsp;KARGO AYARLARI</h3></td>
            <td width="200" bgcolor="#FF9900" align="right"><a href="index.php?SKD=0&SKI=10" style="color: #FFFFFF; text-decoration: none;">+ Yeni Kargo Firması Ekle&nbsp;</a></td>
        </tr>
            ...
            <td colspan="2">
                <table width="750" align="center" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr height="40">
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td><input type="submit" value="Kargo Bilgileri Güncelle" class="YesilButon" ></td>
                    </tr>
                </table>
            </td>
        </tr>
