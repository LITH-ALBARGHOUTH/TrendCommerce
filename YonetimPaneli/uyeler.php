...
if(isset($_REQUEST["AramaIcerigi"])){
    ...
    $AramaKosulu            =    " AND ( EmailAdresi LIKE'%" . $GeleAramaIcerigi . "%' OR IsimSoyisim LIKE'%" . $GeleAramaIcerigi . "%' OR TelefonNumarasi LIKE'%" . $GeleAramaIcerigi . "%' ) ";
...
?>
    <table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td>
                            <div class="AramaAlani">
                                <form action="index.php?SKD=0&SKI=82" method="post" class="search-form">
        ...
        <?php
        $UyelerSorgusu        = $VeriTabaniBaglantisi->prepare("SELECT * FROM uyeler WHERE SilinmeDurumu= ? $AramaKosulu ORDER BY id DESC LIMIT $SayfalamayaBaslanacakKayitSayisi,
                    ...
                    <tr>
                        <td colspan="9" align="right">
                            <table width="95" align="right" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="40">&nbsp;</td>
                                    <td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=84&ID=<?php echo DonusumleriGeriDondur($Uyeler["id"]) ?>">
                                    <img src="../Resimler/carpi.jpg" border="0" style="margin-top: 5px;"></a></td>
                                    <td width="30"  align="left"><a href="index.php?SKD=0&SKI=84&ID=<?php echo DonusumleriGeriDondur($Uyeler["id"]) ?>" 
            ...
            <td colspan="2" align="center">
                ...
                <div class="SayfalamaAlaniKapsayicisi">
                    ...
                    <div class="SayfalamaAlaniIciNumaraAlaniKapsayicisi">
                        <?php
                        if($Sayfalama>1){
                            echo "<span class='SayfalamaAktif'><a href='index.php?SKD=0&SKI=82" . $SayfalamaKosulu . "&SYF=1'><<</a></span>";
                            $SayfalamaIcinSayfaDegeriniBirGeriAl = $Sayfalama-1;
                            echo "<span class='SayfalamaAktif'><a href='index.php?SKD=0&SKI=82" . $SayfalamaKosulu . "&SYF=" . $SayfalamaIcinSayfaDegeriniBirGeriAl . "'><</a></span>";
                        }
                        ...
                        $Sayfalama+$SayfalamaIcınSolVeSagButonSayisi; $SayfalamaIcinSayfaIndexDegeri++) {
                            ...
                            if(($SayfalamaIcinSayfaIndexDegeri>0) && ($SayfalamaIcinSayfaIndexDegeri <= $BulunanSayfaSayisi)){
                                if($Sayfalama==$SayfalamaIcinSayfaIndexDegeri){
                                    ...
                                    echo "<span class='SayfalamaPasif'><a href='index.php?SKD=0&SKI=82" . $SayfalamaKosulu . "&SYF=" . $SayfalamaIcinSayfaIndexDegeri . "'>" . 
                        ...
                        if($Sayfalama != $BulunanSayfaSayisi){
                            ...
                            echo "<span class='SayfalamaAktif'><a href='index.php?SKD=0&SKI=82" . $SayfalamaKosulu . "&SYF=" . $SayfalamaIcinSayfaDegeriniBirIleriAl . "'>></a></span>";
                            echo "<span class='SayfalamaAktif'><a href='index.php?SKD=0&SKI=82" . $SayfalamaKosulu . "&SYF=" . $BulunanSayfaSayisi . "'>>></a></span>";
                        }
