...
?>
<form action="index.php?SKD=0&SKI=2" method="post" enctype="multipart/from-data">
            ...
            <td>
                <table width="750" align="center" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr height="40">
                        <td>X Linki</td>
                        <td>:</td>
                        <td><input type="text" name="SosyalLinkX" value="<?php echo DonusumleriGeriDondur($SosyalLinkX); ?>" class="InputAlanlari" ></td>
                    </tr>
                    <tr height="40">
                    ...
                    <tr height="40">
                        <td>Sanal Pos API Kullanıcı Şifresi</td>
                        <td>:</td>
