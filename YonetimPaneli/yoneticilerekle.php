            ...
            <td colspan="2">
                <table width="750" align="center" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr height="40">
                        ...
                        <td width="20">:</td>
                        <td width="500"><input type="password" name="Sifre" class="InputAlanlari" ></td>
                    </tr>
                    <tr height="40">
                    ...
                    <tr height="40">
                        ...
                        <td width="20">:</td>
                        <td width="500"><input type="mail" name="EmailAdresi" class="InputAlanlari" ></td>
                    </tr>
                    <tr height="40">
                    ...
                    <tr height="40">
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td><input type="submit" value="Yönetici Ekle" class="YesilButon" ></td>
                    </tr>
                </table>
            </td>
        </tr>
