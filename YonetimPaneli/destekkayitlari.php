                    ...
                    <tr height="20">
                        <td align="right">
                            <table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
                                <tr height="20">
                                    <td width="600">&nbsp;</td>
                                    <td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=50&ID=<?php echo DonusumleriGeriDondur($Destek["id"]) ?>"><img src="../Resimler/" border="0" style="margin-top: 5px;"></a></td>
                                    ...
                                    <td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=54&ID=<?php echo DonusumleriGeriDondur($Destek["id"]) ?>"><img src="../Resimler/carpi.jpg" border="0" style="margin-top: 5px;"></a></td>
        ...
        <tr>
            <td colspan="2">
                <table width="750" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr height="40">
                        <td width="750">Kayıtlı Destek Kaydı Bulunmamaktadır.</td>
                    </tr>
                </table>
            </td>
        </tr>
