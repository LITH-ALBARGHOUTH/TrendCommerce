...
<form action="index.php?SKD=0&SKI=39&ID=<?php echo DonusumleriGeriDondur($GelenID); ?>" method="post" enctype="multipart/from-data">
            ...
            <td colspan="2">
                <table width="750" align="center" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr height="40">
                        ...
                        <td width="20">:</td>
                        <td width="500"><input type="text" name="BannerAdi" value="<?php echo DonusumleriGeriDondur($BannerBilgisi["BannerAdi"]); ?>" class="InputAlanlari" ></td>
                    </tr>
                    <tr height="40">
                        ...
                        <td width="500">
                            <select name="BannerAlani" class="SelectAlanlari">
                                ...
                                <option value="Menü Altı"
                                    <?php if (DonusumleriGeriDondur($BannerBilgisi["BannerAlani"])=="Menü Altı"){ ?>
                                        selected="selected"
                                        <?php } ?> > Menü Altı
                                </option>
                                <option value="Ürün Detay" <?php if (DonusumleriGeriDondur($BannerBilgisi["BannerAlani"])=="Ürün Detay"){ ?>
                                        selected="selected"
                                        <?php } ?> >Ürün Detay
                                </option>
                                <option value="Ana Sayfa" <?php if (DonusumleriGeriDondur($BannerBilgisi["BannerAlani"])=="Ana Sayfa"){ ?>
                                        selected="selected"
                                        <?php } ?> >Ana Sayfa
                                </option>
                            </select>
                    ...
                    <tr height="40">
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td><input type="submit" value="Banner Bilgileri Güncelle" class="YesilButon" ></td>
                    </tr>
                </table>
            </td>
        </tr>
