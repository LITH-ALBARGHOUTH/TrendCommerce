...
$SayfalamaIcınSolVeSagButonSayisi           = 2;
    $SayfaBasinaGosterilecekKayitSayisi     = 10;
        ...
        $ToplamKayitSayisiSorgusu           =  $VeriTabaniBaglantisi->prepare("SELECT * FROM urunler WHERE UrunTuru = 'Çocuk Ayakkabısı' AND Durumu= '1' $MenuKosulu $AramaKosulu ORDER BY id DESC");
        $ToplamKayitSayisiSorgusu->execute();
        $ToplamKayitSayisiSorgusu           =  $ToplamKayitSayisiSorgusu->rowCount();
        $SayfalamayaBaslanacakKayitSayisi   =  ($Sayfalama*$SayfaBasinaGosterilecekKayitSayisi)-$SayfaBasinaGosterilecekKayitSayisi;
        $BulunanSayfaSayisi                 =  ceil($ToplamKayitSayisiSorgusu/$SayfaBasinaGosterilecekKayitSayisi);

        $AnaMenununTumUrunSayiSorgusu       =  $VeriTabaniBaglantisi->prepare("SELECT SUM(UrunSayisi) AS MenununToplamUrunu FROM menuler WHERE UrunTuru ='Çocuk Ayakkabısı'");
        ...
        <td width="250" align="left" valign="top">
                ...
                <tr>
                    <td>
                        <table width="250" height="30" align="center" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr height="30">
                                <td>
                                    <a href="index.php?SK=85" style="text-decoration: none; <?php if($GelenMenuId == "") { ?>color: #FF9900;<?php } else 
                            ...
                            $MenulerSorgusu     = $VeriTabaniBaglantisi->prepare("SELECT * FROM menuler WHERE UrunTuru ='Çocuk Ayakkabısı' ORDER BY MenuAdi ASC ");
                            ...
                            <tr height="30">
                                <td>
                                    <a href="index.php?SK=85&MenuID=<?php echo $Menu["id"]; ?>" style="text-decoration: none; <?php if($GelenMenuId == $Menu["id"]) 
                ...
                <td width="805" valign="top">
                    ...
                    <tr>
                        <td>
                            <div class="AramaAlani">
                                <form action="index.php?SK=85" method="post" class="search-form">
                                    <?php
                                    if($GelenMenuId!=""){
                                    ?>
                    ...
                    <tr>
                        <td><table width="805" height="30" align="center" border="0" cellpadding="0" cellspacing="0">
                            <tr>
            <?php
            $UrunlerSorgusu     = $VeriTabaniBaglantisi->prepare("SELECT * FROM urunler WHERE UrunTuru = 'Çocuk Ayakkabısı' AND Durumu= '1' $MenuKosulu $AramaKosulu ORDER BY id DESC LIMIT 
            ...
            <td width="196" valign="top">
                <table width="196" align="left" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 10px;">
                    <tr height="40">
                        <td align="center"><a href="index.php?SK=82&ID=<?php echo DonusumleriGeriDondur($Kayit["id"]); ?>"><img src="Resimler/UrunResimleri/Cocuk/<?php 
                    ...
                    <tr height="25">
                        ...
                        text-decoration: none;'>Çocuk Ayakkabısı</a></td>
                    </tr>
                    <tr height="25">
                ...
                <td align="center">
                    ...
                    <div class="SayfalamaAlaniKapsayicisi">
                        ...
                        <div class="SayfalamaAlaniIciNumaraAlaniKapsayicisi">
                            <?php
                            if($Sayfalama>1){
                                echo "<span class='SayfalamaAktif'><a href='index.php?SK=85" . $SayfalamaKosulu . "&SYF=1'><<</a></span>";
                                $SayfalamaIcinSayfaDegeriniBirGeriAl = $Sayfalama-1;
                                echo "<span class='SayfalamaAktif'><a href='index.php?SK=85" . $SayfalamaKosulu . "&SYF=" . $SayfalamaIcinSayfaDegeriniBirGeriAl . "'><</a></span>";
                            }
                            ...
                            if($Sayfalama != $BulunanSayfaSayisi){
                                ...
                                echo "<span class='SayfalamaAktif'><a href='index.php?SK=85" . $SayfalamaKosulu . "&SYF=" . $SayfalamaIcinSayfaDegeriniBirIleriAl . "'>></a></span>";
                                echo "<span class='SayfalamaAktif'><a href='index.php?SK=85" . $SayfalamaKosulu . "&SYF=" . $BulunanSayfaSayisi . "'>>></a></span>";
                            }
