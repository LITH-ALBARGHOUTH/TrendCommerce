    ...
    <tr>
        <td width="1065" valign="top">
          <table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
             ...
             <tr height="30">
               <td colspan="5" valign="top" style="border-bottom: 1px dashed #CCCCCC;">Tüm Adreslerinizi Görüntüleyebilir Veya Güncelleyebilirsiniz.</td>
             </tr>

             <tr height="50">
                <td colspan="1" style="background: #f8ffa7; color: black; font-weight: bold;" align="left">&nbsp;Adresler</td>
                <td colspan="4" style="background: #f8ffa7; color: black; font-weight: bold;" align="right"><a href="index.php?SK=70" 
                style="text-decoration: none; color: #000000">+ Yeni Adres Ekle</a>&nbsp;</td>
             </tr>
            ...
            <tr height="50">
                <td align="left"><?php  echo $Satirlar['AdiSoyadi']; ?> - <?php  echo $Satirlar['Adres']; ?> <?php  echo $Satirlar['Ilce']; ?> / 
                <?php  echo $Satirlar['Sehir']; ?> - <?php  echo $Satirlar['TelefonNumarasi']; ?></td>
                <td width="25"><img src="" border="0" style="margin-top: 5px;"></td>
            ...
            ?>
             ...
             <tr height="50">
                <td colspan="5" align="left"> Sisteme Kayıtlı Adresiniz Bulunmamakadır. </td>
             </tr>
