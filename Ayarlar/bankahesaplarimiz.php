<table width="1065" height="30" align="center" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td align="left">
            <table width="1065" height="30" align="center" border="0" cellpadding="0" cellspacing="0">
                <?php
                $BankalarSorgusu = $VeriTabaniBaglantisi->prepare("SELECT * FROM bankahesaplari");
                ...
                ?>
                <td width="348">
                    <table width="340" align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #CCCCCC; margin-bottom: 10px;">
                        <tr height="40">
