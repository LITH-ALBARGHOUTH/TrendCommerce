...
if(isset($_SESSION["Kullanici"])){
    ...
    $SayfaBasinaGosterilecekKayitSayisi  = 1;
        ...
        $ToplamKayitSayisiSorgusu           =  $VeriTabaniBaglantisi->prepare("SELECT DISTINCT SiparisNumarasi FROM siparisler WHERE UyeId=? 
        ORDER BY SiparisNumarasi DESC");
    ...
    <tr>
        <td width="1065" valign="top">
          <table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
             ...
             <tr height="30">
               <td colspan="8" valign="top" style="border-bottom: 1px dashed #CCCCCC;">Tüm Siparişlerinizi Buradan Görüntüleyebilirsiniz.</td>
             </tr>
             ...
             <tr height="50">
                ...
                <td width="50" style="background: #f8ffa7; color: black;" align="left">Adedi</td>
                <td width="100" style="background: #f8ffa7; color: black;" align="left">Toplam Fiyatı</td>
                <td width="150" style="background: #f8ffa7; color: black;" align="left">Kargo Durumu / Takip<td>
             </tr>

             <?php
                 $SiparisNumaralariSorgusu    = $VeriTabaniBaglantisi->prepare("SELECT DISTINCT SiparisNumarasi FROM siparisler WHERE UyeId=? 
                 ORDER BY SiparisNumarasi DESC LIMIT $SayfalamayaBaslanacakKayitSayisi,$SayfaBasinaGosterilecekKayitSayisi");
            ...
            <tr height="30">
                ...
                <td width="75" align="left"><img src="Resimler/UrunResimleri/<?php echo $ResimKlasoruAdi; ?>/<?php echo DonusumleriGeriDondur(
                    $SiparisSatirlar["UrunResmiBir"]);?>"border="0" width="60" height="80"></td>
                <td width="50" align="left">
                    <a href="index.php?SK=75&UrunID=<?php echo DonusumleriGeriDondur($SiparisSatirlar["UrunId"]); ?>">
                    <img src="Resimler/yorum.png" border="0"></a>
                </td>
                ...
                <td colspan="8" align="center">
                    ...
                    <div class="SayfalamaAlaniKapsayicisi">
                        ...
                        <div class="SayfalamaAlaniIciNumaraAlaniKapsayicisi">
                            <?php
                            if($Sayfalama>1){
                                echo "<span class='SayfalamaAktif'><a href='index.php?SK=61&SYF=1'><<</a></span>";
                                $SayfalamaIcinSayfaDegeriniBirGeriAl = $Sayfalama-1;
                                echo "<span class='SayfalamaAktif'><a href='index.php?SK=61&SYF=" . $SayfalamaIcinSayfaDegeriniBirGeriAl . "'><</a></span>";
                            }
                            ...
                            $Sayfalama+$SayfalamaIcınSolVeSagButonSayisi; $SayfalamaIcinSayfaIndexDegeri++) {
                                ...
                                if(($SayfalamaIcinSayfaIndexDegeri>0) && ($SayfalamaIcinSayfaIndexDegeri <= $BulunanSayfaSayisi)){
                                    if($Sayfalama==$SayfalamaIcinSayfaIndexDegeri){
                                        ...
                                        echo "<span class='SayfalamaPasif'><a href='index.php?SK=61&SYF=" . $SayfalamaIcinSayfaIndexDegeri . "'>" . 
                            ...
                            if($Sayfalama != $BulunanSayfaSayisi){
                                ...
                                echo "<span class='SayfalamaAktif'><a href='index.php?SK=61&SYF=" . $SayfalamaIcinSayfaDegeriniBirIleriAl . "'>></a></span>";
                                echo "<span class='SayfalamaAktif'><a href='index.php?SK=61&SYF=" . $BulunanSayfaSayisi . "'>>></a></span>";
                            }
            ...
            ?>
             ...
             <tr height="50">
                <td colspan="8" align="left"> Sisteme Kayıtlı Siparişiniz Bulunmamakadır. </td>
             </tr>
